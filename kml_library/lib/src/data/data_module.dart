...
final libraryDatabaseProvider =
    Provider<ILibraryDatabase>((_) => LibraryDatabase());
final libraryRepositoryProvider = Provider<ILibraryRepository>(
    (ref) => LibraryRepository(ref.watch(libraryDatabaseProvider)));
